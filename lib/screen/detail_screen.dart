...
class DetailScreen extends StatelessWidget {
  ...
  const DetailScreen({super.key, required this.formData});
                  ...
                  child: Container(
                    ...
                    child: DottedBorder(
                      ...
                      child: Center(
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8),
                          child: formData.imagePath.isNotEmpty
                              ? Image.file(
